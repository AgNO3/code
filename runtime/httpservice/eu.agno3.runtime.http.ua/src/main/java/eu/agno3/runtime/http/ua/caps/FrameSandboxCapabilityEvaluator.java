 ...
 *
 */
public class FrameSandboxCapabilityEvaluator implements CapabilityEvaluator {

    private static final Logger log = Logger.getLogger(FrameSandboxCapabilityEvaluator.class);
    ...
    private static boolean firefoxHasCapability ( VersionNumber versionNumber ) {
        return Integer.parseInt(versionNumber.getMajor()) >= 17;
    }
