 ...
 *
 */
public class CSPStandardHeaderCapabilityEvaluator implements CapabilityEvaluator {

    private static final Logger log = Logger.getLogger(CSPStandardHeaderCapabilityEvaluator.class);
    ...
    private static boolean internetExplorerHasCapability ( VersionNumber versionNumber ) {
        return Integer.parseInt(versionNumber.getMajor()) >= 12;
    }
