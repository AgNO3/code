 ...
 *
 */
public class CSPWebkitHeaderCapabilityEvaluator implements CapabilityEvaluator {

    private static final Logger log = Logger.getLogger(CSPWebkitHeaderCapabilityEvaluator.class);
