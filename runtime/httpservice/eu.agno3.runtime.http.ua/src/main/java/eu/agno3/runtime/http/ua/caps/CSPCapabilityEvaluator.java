 ...
 *
 */
public class CSPCapabilityEvaluator implements CapabilityEvaluator {

    private static final Logger log = Logger.getLogger(CSPCapabilityEvaluator.class);
    ...
    private static boolean safariHasCapability ( VersionNumber versionNumber ) {
        return Integer.parseInt(versionNumber.getMajor()) >= 7;
    }
    ...
    private static boolean chromeHasCapability ( VersionNumber versionNumber ) {
        return Integer.parseInt(versionNumber.getMajor()) >= 25;
    }
    ...
    private static boolean firefoxHasCapability ( VersionNumber versionNumber ) {
        return Integer.parseInt(versionNumber.getMajor()) >= 23;
    }
}
