...
public class DialogOpenCommandLink extends CommandLink implements DialogOpenComponent, ClientBehaviorHolder {
    ...
    private static Logger log = Logger.getLogger(DialogOpenCommandLink.class);
