 ...
 * @see PortAssigner
 */
public final class AFUNIXRMIPorts {
    ...
    /**
     * This port is used to state that the socket path specified in {@link AFUNIXRMISocketFactory} points to a socket
     * <em>file</em>, not a directory.
     */
