 ...
 *
 */
public class PeerSharedByTreeNode extends AbstractBrowseTreeNode implements LabelNode {
     ...
     */
    public PeerSharedByTreeNode ( AbstractBrowseTreeNode parent, PeerInfo s, BrowseTreeProvider browseTreeProvider ) {
    ...
    public String getIcon () {
        return "ui-icon-arrowthick-1-w"; //$NON-NLS-1$
    }
    ...
    public String getType () {
        return FileTreeConstants.PEER_SHARED_BY_TYPE;
    }
    ...
    protected List<? extends TreeNode> fetchChildren () {
        return this.getTreeProvider().getSharedByChildren(this);
    }
