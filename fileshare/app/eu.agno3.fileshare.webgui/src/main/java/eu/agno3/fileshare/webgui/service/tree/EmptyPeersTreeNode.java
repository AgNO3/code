 ...
 *
 */
public class EmptyPeersTreeNode extends AbstractVirtualEmptyTreeNode {
     ...
     * @param treeProvider
     */
    public EmptyPeersTreeNode ( BrowseTreeNode parent, BrowseTreeProvider treeProvider ) {
     ...
     * @param treeProvder
     */
    public EmptyPeersTreeNode ( BrowseTreeProvider treeProvder ) {
        super(treeProvder);
    }
     ...
     * @param treeProvider
     */
    public EmptyPeersTreeNode ( VFSEntity obj, BrowseTreeNode parent, BrowseTreeProvider treeProvider ) {
