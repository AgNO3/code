...
@ViewScoped
@Named ( "ownedEntityPicker" )
public class OwnedEntityPicker extends AbstractFilePicker implements TreeFilter, Predicate<TreeNode> {
    ...
    protected boolean acceptSelection ( BrowseTreeNode selected ) {
        ...
        EntityTreeNode en = (EntityTreeNode) selected;
     ...
     * {@inheritDoc}
     *
     * @see eu.agno3.fileshare.webgui.service.file.picker.AbstractFilePicker#addShared()
     */
    @Override
    ...
    public boolean test ( TreeNode t ) {
        ...
        if ( ! ( bt instanceof EntityTreeNode ) && ! ( bt instanceof GroupTreeNode ) ) {
            return true;
        }
