 ...
 *
 */
public class PeersTreeNode extends AbstractBrowseTreeNode implements BrowseTreeNode {
     ...
     * @param treeProvider
     */
    public PeersTreeNode ( RootTreeNode parent, BrowseTreeProvider treeProvider ) {
     ...
     */
    public PeersTreeNode ( BrowseTreeProvider adapterFactory ) {
    ...
    public String getType () {
        return FileTreeConstants.PEERS_ROOT_TYPE;
    }
    ...
    protected List<BrowseTreeNode> fetchChildren () {
        List<BrowseTreeNode> sharedChildren = this.getTreeProvider().getPeersChildren(this);
        if ( sharedChildren.isEmpty() ) {
            sharedChildren.add(new EmptyPeersTreeNode());
        }
