...
public class FileshareMailResourceLibraryDescriptor implements ResourceLibraryDescriptor {

    /**
     * 
     */
    public static final String RESOURCE_LIBRARY_TYPE = "fs_mail"; //$NON-NLS-1$
