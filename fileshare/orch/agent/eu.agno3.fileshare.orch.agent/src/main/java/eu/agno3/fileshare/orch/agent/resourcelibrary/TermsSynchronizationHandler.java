...
public class TermsSynchronizationHandler extends AbstractResourceLibraryConfigFilesSynchronizationHandler {
    ...
    public String getType () {
        return TermsResourceLibraryDescriptor.RESOURCE_LIBRARY_TYPE;
    }
    ...
    protected ConfigFileManager getManager ( StructuralObjectReference service ) throws ResourceLibraryException {
        try {
            ...
            return cfm.getCfgFileRoot("terms"); //$NON-NLS-1$
        }
        catch (
            IOException |
