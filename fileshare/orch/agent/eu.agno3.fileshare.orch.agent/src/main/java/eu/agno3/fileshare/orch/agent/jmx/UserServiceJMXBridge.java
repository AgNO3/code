 ...
 *
 */
@Component ( service = RequestEndpoint.class, property = "msgType=eu.agno3.fileshare.orch.common.jmx.FileshareUserJMXRequest" )
public class UserServiceJMXBridge extends AbstractJMSJMXBridge<FileshareUserJMXRequest, FileshareJMXErrorResponse> {

    private static final Logger log = Logger.getLogger(UserServiceJMXBridge.class);
     ...
     */
    @Override
    public Class<FileshareUserJMXRequest> getMessageType () {
        return FileshareUserJMXRequest.class;
    }
     ...
     */
    @Override
    protected JMXErrorResponse createErrorResponse ( FileshareUserJMXRequest msg ) throws MessagingException {
     ...
     */
    @Override
    protected MBeanServerConnection getMBeanServerConnection ( @NonNull FileshareUserJMXRequest msg ) throws MessagingException {
        try {
