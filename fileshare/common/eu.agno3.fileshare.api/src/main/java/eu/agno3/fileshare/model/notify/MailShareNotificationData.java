 ...
 *
 */
public class MailShareNotificationData implements Serializable, MailNotificationData, LinkShareData {
     ...
     *            the grant to set
     */
    public void setGrant ( MailGrant grant ) {
        this.grant = grant;
    }
    ...
    public String getFormattedSize () {
        if ( ! ( getEntity() instanceof VFSFileEntity ) ) {
            return null;
        }
        VFSFileEntity fe = (VFSFileEntity) getEntity();
