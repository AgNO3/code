...
public class ConfigurationContextServiceDescriptor extends AbstractSOAPServiceClientDescriptor<ConfigurationContextService> {

    /**
     */
    public ConfigurationContextServiceDescriptor () {
        super(ConfigurationContextService.class, DEFAULT_SERVICE_QNAME, "/realm/config/context"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:realm:service:config:context"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "configContextService"; //$NON-NLS-1$
