...
public class ConfigurationJobGroup implements JobGroup {
    ...
    public boolean conflicts ( Job j1, Job j2 ) {
        ...
        if ( j1 instanceof ConfigurationJob && j2 instanceof ConfigurationJob ) {
            return true;
        }
    ...
    public boolean equals ( Object other ) {
        return other instanceof ConfigurationJobGroup;
    }
}
