...
public class EnforcementServiceDescriptor extends AbstractSOAPServiceClientDescriptor<EnforcementService> {

    /**
     * 
     */
    public EnforcementServiceDescriptor () {
        super(EnforcementService.class, DEFAULT_SERVICE_QNAME, "/realm/enforcement"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:realm:service:enforcements"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "enforcementService"; //$NON-NLS-1$
