...
public class ConfigApplyServiceDescriptor extends AbstractSOAPServiceClientDescriptor<ConfigApplyService> {

    /**
     * 
     */
    public ConfigApplyServiceDescriptor () {
        super(ConfigApplyService.class, DEFAULT_SERVICE_QNAME, "/realm/applyConfig"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:realm:service:configApply"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "configApplyService"; //$NON-NLS-1$
