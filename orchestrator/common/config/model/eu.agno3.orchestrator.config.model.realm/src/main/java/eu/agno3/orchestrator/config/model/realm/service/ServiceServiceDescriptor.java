...
public class ServiceServiceDescriptor extends AbstractSOAPServiceClientDescriptor<ServiceService> {

    /**
     * 
     */
    public ServiceServiceDescriptor () {
        super(ServiceService.class, DEFAULT_SERVICE_QNAME, "/realm/service"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:realm:service:service"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "serviceService"; //$NON-NLS-1$
