...
public class InheritanceServiceDescriptor extends AbstractSOAPServiceClientDescriptor<InheritanceService> {

    /**
     * 
     */
    public InheritanceServiceDescriptor () {
        super(InheritanceService.class, DEFAULT_SERVICE_QNAME, "/realm/inheritance"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:realm:service:inheritance"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "inheritanceService"; //$NON-NLS-1$
