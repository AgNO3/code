...
public class ConfigurationServiceDescriptor extends AbstractSOAPServiceClientDescriptor<ConfigurationService> {

    /**
     */
    public ConfigurationServiceDescriptor () {
        super(ConfigurationService.class, DEFAULT_SERVICE_QNAME, "/realm/config"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:realm:service:config"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "configService"; //$NON-NLS-1$
