...
public class ServiceConfigAppliedEvent extends XmlMarshallableMessage<@NonNull MessageSource> implements EventMessage<@NonNull MessageSource> {
     ...
     * 
     */
    public ServiceConfigAppliedEvent () {
        super();
    }
     ...
     * @param ttl
     */
    public ServiceConfigAppliedEvent ( @NonNull MessageSource origin, int ttl ) {
        super(origin, ttl);
    }
     ...
     * @param replyTo
     */
    public ServiceConfigAppliedEvent ( @NonNull MessageSource origin, Message<@NonNull ? extends MessageSource> replyTo ) {
     ...
     * @param origin
     */
    public ServiceConfigAppliedEvent ( @NonNull MessageSource origin ) {
        super(origin);
    }
