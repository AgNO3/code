...
public class OrchestratorWebResourceLibraryDescriptor implements ResourceLibraryDescriptor {

    /**
     * 
     */
    public static final String RESOURCE_LIBRARY_TYPE = "orch_web"; //$NON-NLS-1$
