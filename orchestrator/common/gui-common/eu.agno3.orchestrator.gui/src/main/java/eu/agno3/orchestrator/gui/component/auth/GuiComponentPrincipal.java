 ...
 */
package eu.agno3.orchestrator.gui.component.auth;
 ...
 *
 */
public class GuiComponentPrincipal extends AbstractComponentPrincipal implements ComponentPrincipal {

    /**
     * 
     */
    public static final String GUI_USER_PREFIX = "gui-"; //$NON-NLS-1$
     ...
     * @param componentId
     */
    public GuiComponentPrincipal ( @NonNull UUID componentId ) {
        super(GUI_USER_PREFIX, componentId);
    }
