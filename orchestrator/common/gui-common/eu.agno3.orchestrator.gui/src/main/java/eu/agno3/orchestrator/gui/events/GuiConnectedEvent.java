...
public class GuiConnectedEvent extends EmptyMessage<@NonNull GuiMessageSource> implements EventMessage<@NonNull GuiMessageSource> {

    /**
     * 
     */
    public GuiConnectedEvent () {
        super();
    }
     ...
     * @param ttl
     */
    public GuiConnectedEvent ( @NonNull GuiMessageSource origin, int ttl ) {
        super(origin, ttl);
    }
     ...
     * @param messageSource
     */
    public GuiConnectedEvent ( @NonNull GuiMessageSource messageSource ) {
        super(messageSource);
    }
