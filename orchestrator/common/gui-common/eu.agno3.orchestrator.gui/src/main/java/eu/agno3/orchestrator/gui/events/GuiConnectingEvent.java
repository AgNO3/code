...
public class GuiConnectingEvent extends EmptyMessage<@NonNull GuiMessageSource> implements EventMessage<@NonNull GuiMessageSource> {

    /**
     * 
     */
    public GuiConnectingEvent () {
        super();
    }
     ...
     * @param ttl
     */
    public GuiConnectingEvent ( @NonNull GuiMessageSource origin, int ttl ) {
        super(origin, ttl);
    }
     ...
     * @param messageSource
     */
    public GuiConnectingEvent ( @NonNull GuiMessageSource messageSource ) {
        super(messageSource);
    }
