...
public class GuiDownEvent extends XmlMarshallableMessage<@NonNull GuiMessageSource> implements EventMessage<@NonNull GuiMessageSource> {
     ...
     * @param origin
     */
    public GuiDownEvent ( UUID guiId, @NonNull GuiMessageSource origin ) {
        super(origin);
        this.guiId = guiId;
    }
