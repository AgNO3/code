...
public class AgentIllegalConnStateEvent extends XmlMarshallableMessage<@NonNull ServerMessageSource>
        implements EventMessage<@NonNull ServerMessageSource> {
     ...
     * 
     */
    public AgentIllegalConnStateEvent () {
        super();
    }
     ...
     * @param origin
     */
    public AgentIllegalConnStateEvent ( UUID agentId, @NonNull ServerMessageSource origin ) {
        super(origin);
    ...
    public Set<EventScope> getScopes () {
        ...
        scopes.add(new AgentEventScope(this.agentId));
