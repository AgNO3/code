...
public class AgentConnectedEvent extends EmptyMessage<@NonNull AgentMessageSource> implements EventMessage<@NonNull AgentMessageSource> {

    /**
     * 
     */
    public AgentConnectedEvent () {
        super();
    }
     ...
     * @param ttl
     */
    public AgentConnectedEvent ( @NonNull AgentMessageSource origin, int ttl ) {
        super(origin, ttl);
    }
     ...
     * @param messageSource
     */
    public AgentConnectedEvent ( @NonNull AgentMessageSource messageSource ) {
        super(messageSource);
    }
