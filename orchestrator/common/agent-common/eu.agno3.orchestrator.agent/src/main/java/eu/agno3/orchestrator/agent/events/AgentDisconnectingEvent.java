...
public class AgentDisconnectingEvent extends EmptyMessage<@NonNull AgentMessageSource> implements EventMessage<@NonNull AgentMessageSource> {

    /**
     * 
     */
    public AgentDisconnectingEvent () {
        super();
    }
     ...
     * @param ttl
     */
    public AgentDisconnectingEvent ( @NonNull AgentMessageSource origin, int ttl ) {
        super(origin, ttl);
    }
     ...
     * @param messageSource
     */
    public AgentDisconnectingEvent ( @NonNull AgentMessageSource messageSource ) {
        super(messageSource);
    }
