...
public final class MonitoringServiceDescriptor extends AbstractSOAPServiceClientDescriptor<MonitoringService> {

    /**
     * 
     */
    public MonitoringServiceDescriptor () {
        super(MonitoringService.class, DEFAULT_SERVICE_QNAME, "/agent/monitor"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:system:monitor:service"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "monitorService"; //$NON-NLS-1$
