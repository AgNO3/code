...
public final class LoggingServiceDescriptor extends AbstractSOAPServiceClientDescriptor<LoggingService> {

    /**
     * 
     */
    public LoggingServiceDescriptor () {
        super(LoggingService.class, DEFAULT_SERVICE_QNAME, "/agent/log"); //$NON-NLS-1$
    }

    /**
     * 
     */
    public static final String NAMESPACE = "urn:agno3:model:1.0:system:logging:service"; //$NON-NLS-1$

    /**
     * 
     */
    public static final String DEFAULT_SERVICE_NAME = "loggingService"; //$NON-NLS-1$
