 ...
 * 
 */
@Component ( service = EventRouter.class, property = "scopeClass=eu.agno3.orchestrator.gui.msg.addressing.GuisEventScope", immediate = true )
public class GuisScopeRouter extends AbstractServerEventRouter {
