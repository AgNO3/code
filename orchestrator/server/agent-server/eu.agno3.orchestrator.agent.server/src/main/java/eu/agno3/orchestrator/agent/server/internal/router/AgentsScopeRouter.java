 ...
 * 
 */
@Component ( service = EventRouter.class, property = "scopeClass=eu.agno3.orchestrator.agent.msg.addressing.AgentsEventScope", immediate = true )
public class AgentsScopeRouter extends AbstractServerEventRouter {
