 ...
 *
 */
@Component ( service = EventListener.class, property = "eventType=eu.agno3.orchestrator.system.update.msg.SystemRevertedEvent" )
public class RevertedEventListener implements EventListener<SystemRevertedEvent> {

    private static final Logger log = Logger.getLogger(RevertedEventListener.class);
     ...
     */
    @Override
    public void onEvent ( @NonNull SystemRevertedEvent event ) {
        @NonNull
        ...
        try {
            ...
            this.updateService.reverted(instance, event.getRevertedToStream(), event.getRevertedToSequence());
        }
        catch (
     ...
     */
    @Override
    public @NonNull Class<SystemRevertedEvent> getEventType () {
        return SystemRevertedEvent.class;
    }
