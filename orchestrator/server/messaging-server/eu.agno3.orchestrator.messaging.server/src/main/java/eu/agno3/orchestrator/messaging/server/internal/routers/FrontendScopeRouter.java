 ...
 * 
 */
@Component ( service = EventRouter.class, property = "scopeClass=eu.agno3.runtime.messaging.addressing.scopes.FrontendEventScope" )
public class FrontendScopeRouter extends AbstractServerEventRouter {
