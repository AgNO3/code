 ...
 * 
 */
@Component ( service = EventRouter.class, property = "scopeClass=eu.agno3.runtime.messaging.addressing.scopes.ServersEventScope" )
public class ServersScopeRouter extends AbstractServerEventRouter {
