 ...
 * 
 */
@Component ( service = EventRouter.class, property = "scopeClass=eu.agno3.runtime.messaging.addressing.scopes.ServerEventScope" )
public class ServerScopeRouter extends AbstractServerEventRouter {
