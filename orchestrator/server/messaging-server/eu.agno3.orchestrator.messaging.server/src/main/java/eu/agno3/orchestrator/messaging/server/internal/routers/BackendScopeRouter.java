 ...
 * 
 */
@Component ( service = EventRouter.class, property = "scopeClass=eu.agno3.runtime.messaging.addressing.scopes.BackendEventScope" )
public class BackendScopeRouter extends AbstractServerEventRouter {
