 ...
 *
 */
@Component ( service = RequestEndpoint.class, property = "msgType=eu.agno3.orchestrator.system.backups.msg.BackupRemoveRequest" )
public class BackupRemoveRequestEndpoint implements RequestEndpoint<BackupRemoveRequest, BackupListResponse, DefaultXmlErrorResponseMessage> {
     ...
     */
    @Override
    public BackupListResponse onReceive ( @NonNull BackupRemoveRequest msg ) throws MessageProcessingException, MessagingException {
        try {
            this.backupManager.remove(msg.getBackupId());
     ...
     */
    @Override
    public Class<BackupRemoveRequest> getMessageType () {
        return BackupRemoveRequest.class;
    }
