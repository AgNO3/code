 ...
 *
 */
public class ReestablishAgentConnection
        extends AbstractExecutionUnit<StatusOnlyResult, ReestablishAgentConnection, ReestablishAgentConnectionConfigururator> {
     ...
     */
    @Override
    public ReestablishAgentConnectionConfigururator createConfigurator () {
        return new ReestablishAgentConnectionConfigururator(this);
    }
