...
@Component (
    ...
    property = "msgType=eu.agno3.orchestrator.config.model.realm.resourcelibrary.ResourceLibraryListRequest" )
public class ResourceLibraryListRequestEndpoint extends AbstractResourceLibraryRequestEndpoint<ResourceLibraryListRequest> {
    ...
    @Override
    protected List<ResourceLibraryEntry> getResults ( @NonNull ResourceLibraryListRequest msg ) throws ResourceLibraryException {
        return getSynchronizationHandler(msg.getLibraryType()).list(StructuralObjectReferenceImpl.fromObject(msg.getServiceTarget()), msg.getHint());
    }
     ...
     */
    @Override
    public Class<ResourceLibraryListRequest> getMessageType () {
        return ResourceLibraryListRequest.class;
    }
