 ...
 * 
 */
public class AffectedByDataModelBean extends AbstractObjectUsageDataModelBean {
     ...
     * 
     */
    public AffectedByDataModelBean ( ServerServiceProvider ssp, ConfigurationObject obj ) {
        super("affectedBy", ssp, obj); //$NON-NLS-1$
    }
    ...
    protected Set<ConfigurationObject> createModel ( ConfigurationObject obj ) throws GuiWebServiceException, ModelObjectNotFoundException,
        ...
        return this.getSsp().getService(UsageService.class).getAffectedBy(obj);
    }
