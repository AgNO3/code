 ...
 * 
 */
public class DefaultForDataModelBean extends AbstractObjectUsageDataModelBean {
     ...
     * 
     */
    public DefaultForDataModelBean ( ServerServiceProvider ssp, ConfigurationObject obj ) {
        super("defaultFor", ssp, obj); //$NON-NLS-1$
    }
    ...
    protected Set<ConfigurationObject> createModel ( ConfigurationObject obj ) throws GuiWebServiceException, ModelObjectNotFoundException,
        ...
        return this.getSsp().getService(UsageService.class).getDefaultFor(obj);
    }
