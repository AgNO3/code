 ...
 * 
 */
public class ClosureUsedByDataModelBean extends AbstractObjectUsageDataModelBean {
     ...
     * 
     */
    public ClosureUsedByDataModelBean ( ServerServiceProvider ssp, ConfigurationObject obj ) {
        super("closure-usedBy", ssp, obj); //$NON-NLS-1$
    }
    ...
    protected Set<ConfigurationObject> createModel ( ConfigurationObject obj ) throws GuiWebServiceException, ModelObjectNotFoundException,
        ...
        return this.getSsp().getService(UsageService.class).getUsedByClosure(obj);
    }
