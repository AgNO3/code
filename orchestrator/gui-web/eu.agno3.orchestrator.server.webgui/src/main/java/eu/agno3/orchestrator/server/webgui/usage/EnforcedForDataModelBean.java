 ...
 * 
 */
public class EnforcedForDataModelBean extends AbstractObjectUsageDataModelBean {
     ...
     * 
     */
    public EnforcedForDataModelBean ( ServerServiceProvider ssp, ConfigurationObject obj ) {
        super("enforcedFor", ssp, obj); //$NON-NLS-1$
    }
    ...
    protected Set<ConfigurationObject> createModel ( ConfigurationObject obj ) throws GuiWebServiceException, ModelObjectNotFoundException,
        ...
        return this.getSsp().getService(UsageService.class).getEnforcedFor(obj);
    }
