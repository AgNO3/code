 ...
 */
@ViewScoped
@Named ( "defaultAddContext" )
public class DefaultAddContextBean implements Serializable {
    ...
    public List<ConfigurationObjectReference> getTemplatesForTypeName ( String type ) throws ModelObjectNotFoundException, ModelServiceException,
            GuiWebServiceException {
        if ( type == null ) {
