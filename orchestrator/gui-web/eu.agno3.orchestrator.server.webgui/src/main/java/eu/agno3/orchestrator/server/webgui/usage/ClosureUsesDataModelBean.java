 ...
 * 
 */
public class ClosureUsesDataModelBean extends AbstractObjectUsageDataModelBean {
     ...
     * 
     */
    public ClosureUsesDataModelBean ( ServerServiceProvider ssp, ConfigurationObject obj ) {
        super("closure-uses", ssp, obj); //$NON-NLS-1$
    }
    ...
    protected Set<ConfigurationObject> createModel ( ConfigurationObject obj ) throws GuiWebServiceException, ModelObjectNotFoundException,
        ...
        return this.getSsp().getService(UsageService.class).getUsesClosure(obj);
    }
